...
local RayfieldLibrary = {
  ...
  Theme = {
    ...
    Ocean = {
      ...
      TabBackground = Color3.fromRGB(30, 60, 90),
      TabStroke = Color3.fromRGB(40, 80, 120),
      TabBackgroundSelected = Color3.fromRGB(65, 180, 230),
      TabTextColor = Color3.fromRGB(220, 240, 255),
      SelectedTabTextColor = Color3.fromRGB(15, 25, 35),

      ElementBackground = Color3.fromRGB(25, 45, 65),
      ElementBackgroundHover = Color3.fromRGB(30, 55, 80),
      SecondaryElementBackground = Color3.fromRGB(20, 35, 50),
      ElementStroke = Color3.fromRGB(45, 95, 145),
      SecondaryElementStroke = Color3.fromRGB(35, 70, 105),

      SliderBackground = Color3.fromRGB(40, 120, 180),
      SliderProgress = Color3.fromRGB(50, 150, 220),
      SliderStroke = Color3.fromRGB(60, 170, 240),

      ToggleBackground = Color3.fromRGB(25, 45, 65),
      ToggleEnabled = Color3.fromRGB(30, 160, 220),
      ToggleDisabled = Color3.fromRGB(80, 90, 100),
      ToggleEnabledStroke = Color3.fromRGB(50, 190, 255),
      ToggleDisabledStroke = Color3.fromRGB(100, 110, 120),
      ToggleEnabledOuterStroke = Color3.fromRGB(85, 85, 95),
      ToggleDisabledOuterStroke = Color3.fromRGB(60, 60, 70),

      InputBackground = Color3.fromRGB(25, 45, 65),
      InputStroke = Color3.fromRGB(50, 100, 150),
    ...
    Sunset = {
      ...
      NotificationBackground = Color3.fromRGB(30, 20, 35),
      NotificationActionsBackground = Color3.fromRGB(255, 200, 150),

      TabBackground = Color3.fromRGB(80, 50, 90),
      TabStroke = Color3.fromRGB(100, 60, 110),
      TabBackgroundSelected = Color3.fromRGB(255, 140, 80),
      TabTextColor = Color3.fromRGB(255, 240, 230),
      SelectedTabTextColor = Color3.fromRGB(30, 20, 35),

      ElementBackground = Color3.fromRGB(50, 35, 60),
      ElementBackgroundHover = Color3.fromRGB(60, 45, 75),
      SecondaryElementBackground = Color3.fromRGB(40, 25, 50),
      ElementStroke = Color3.fromRGB(120, 70, 130),
      SecondaryElementStroke = Color3.fromRGB(90, 50, 100),

      SliderBackground = Color3.fromRGB(200, 100, 120),
      SliderProgress = Color3.fromRGB(255, 130, 70),
      SliderStroke = Color3.fromRGB(255, 160, 100),

      ToggleBackground = Color3.fromRGB(50, 35, 60),
      ToggleEnabled = Color3.fromRGB(255, 120, 60),
      ToggleDisabled = Color3.fromRGB(90, 80, 95),
      ToggleEnabledStroke = Color3.fromRGB(255, 160, 100),
      ToggleDisabledStroke = Color3.fromRGB(110, 100, 115),
      ToggleEnabledOuterStroke = Color3.fromRGB(180, 90, 120),
      ToggleDisabledOuterStroke = Color3.fromRGB(70, 60, 80),

      InputBackground = Color3.fromRGB(50, 35, 60),
      InputStroke = Color3.fromRGB(120, 70, 90),
      PlaceholderColor = Color3.fromRGB(180, 160, 170)
    },
    Forest = {
      TextFont = "Default",
      ...
      NotificationBackground = Color3.fromRGB(20, 30, 20),
      NotificationActionsBackground = Color3.fromRGB(200, 230, 200),

      TabBackground = Color3.fromRGB(50, 75, 50),
      TabStroke = Color3.fromRGB(60, 90, 60),
      TabBackgroundSelected = Color3.fromRGB(120, 200, 120),
      TabTextColor = Color3.fromRGB(230, 245, 230),
      SelectedTabTextColor = Color3.fromRGB(20, 30, 20),

      ElementBackground = Color3.fromRGB(35, 50, 35),
      ElementBackgroundHover = Color3.fromRGB(45, 65, 45),
      SecondaryElementBackground = Color3.fromRGB(25, 40, 25),
      ElementStroke = Color3.fromRGB(70, 110, 70),
      SecondaryElementStroke = Color3.fromRGB(50, 80, 50),

      SliderBackground = Color3.fromRGB(60, 140, 60),
      SliderProgress = Color3.fromRGB(80, 180, 80),
      SliderStroke = Color3.fromRGB(100, 200, 100),

      ToggleBackground = Color3.fromRGB(35, 50, 35),
      ToggleEnabled = Color3.fromRGB(70, 200, 70),
      ToggleDisabled = Color3.fromRGB(85, 95, 85),
      ToggleEnabledStroke = Color3.fromRGB(100, 230, 100),
      ToggleDisabledStroke = Color3.fromRGB(105, 115, 105),
      ToggleEnabledOuterStroke = Color3.fromRGB(90, 160, 90),
      ToggleDisabledOuterStroke = Color3.fromRGB(60, 70, 60),

      InputBackground = Color3.fromRGB(35, 50, 35),
      InputStroke = Color3.fromRGB(70, 110, 70),
      PlaceholderColor = Color3.fromRGB(160, 185, 160)
    },
    Purple = {
      TextFont = "Default",
      ...
      Topbar = Color3.fromRGB(40, 30, 55),
      Shadow = Color3.fromRGB(20, 15, 30),

      NotificationBackground = Color3.fromRGB(25, 20, 35),
      NotificationActionsBackground = Color3.fromRGB(220, 210, 240),

      TabBackground = Color3.fromRGB(70, 50, 100),
      TabStroke = Color3.fromRGB(85, 60, 120),
      TabBackgroundSelected = Color3.fromRGB(160, 100, 230),
      TabTextColor = Color3.fromRGB(240, 230, 255),
      SelectedTabTextColor = Color3.fromRGB(25, 20, 35),

      ElementBackground = Color3.fromRGB(45, 35, 65),
      ElementBackgroundHover = Color3.fromRGB(55, 45, 80),
      SecondaryElementBackground = Color3.fromRGB(35, 25, 50),
      ElementStroke = Color3.fromRGB(100, 70, 150),
      SecondaryElementStroke = Color3.fromRGB(75, 50, 110),

      SliderBackground = Color3.fromRGB(120, 80, 180),
      SliderProgress = Color3.fromRGB(150, 100, 220),
      SliderStroke = Color3.fromRGB(170, 120, 240),

      ToggleBackground = Color3.fromRGB(45, 35, 65),
      ToggleEnabled = Color3.fromRGB(140, 90, 220),
      ToggleDisabled = Color3.fromRGB(90, 85, 100),
      ToggleEnabledStroke = Color3.fromRGB(170, 120, 255),
      ToggleDisabledStroke = Color3.fromRGB(110, 105, 120),
      ToggleEnabledOuterStroke = Color3.fromRGB(110, 80, 150),
      ToggleDisabledOuterStroke = Color3.fromRGB(65, 60, 75),

      InputBackground = Color3.fromRGB(45, 35, 65),
      InputStroke = Color3.fromRGB(100, 70, 150),
      PlaceholderColor = Color3.fromRGB(170, 160, 190)
    },
    Cyber = {
      TextFont = "Default",
      ...
      Topbar = Color3.fromRGB(15, 15, 30),
      Shadow = Color3.fromRGB(5, 5, 15),

      NotificationBackground = Color3.fromRGB(10, 10, 20),
      NotificationActionsBackground = Color3.fromRGB(0, 240, 240),

      TabBackground = Color3.fromRGB(30, 30, 50),
      TabStroke = Color3.fromRGB(0, 200, 200),
      TabBackgroundSelected = Color3.fromRGB(255, 0, 150),
      ...
      ElementStroke = Color3.fromRGB(0, 220, 220),
      SecondaryElementStroke = Color3.fromRGB(0, 180, 180),

      SliderBackground = Color3.fromRGB(200, 0, 150),
      SliderProgress = Color3.fromRGB(255, 0, 180),
      SliderStroke = Color3.fromRGB(255, 50, 200),
      ...
      ToggleEnabledOuterStroke = Color3.fromRGB(255, 0, 150),
      ToggleDisabledOuterStroke = Color3.fromRGB(60, 60, 70),

      InputBackground = Color3.fromRGB(20, 20, 35),
      InputStroke = Color3.fromRGB(0, 220, 220),
      PlaceholderColor = Color3.fromRGB(0, 200, 200)
    },
    Crimson = {
      TextFont = "Default",
      ...
      TabBackground = Color3.fromRGB(60, 20, 20),
      ...
      ElementBackground = Color3.fromRGB(40, 15, 15),
      ElementBackgroundHover = Color3.fromRGB(55, 20, 20),
      SecondaryElementBackground = Color3.fromRGB(30, 10, 10),
      ElementStroke = Color3.fromRGB(150, 40, 40),
      SecondaryElementStroke = Color3.fromRGB(100, 25, 25),

      SliderBackground = Color3.fromRGB(180, 60, 60),
      SliderProgress = Color3.fromRGB(220, 50, 50),
      SliderStroke = Color3.fromRGB(255, 80, 80),

      ToggleBackground = Color3.fromRGB(40, 15, 15),
      ToggleEnabled = Color3.fromRGB(220, 50, 50),
      ToggleDisabled = Color3.fromRGB(90, 70, 70),
      ToggleEnabledStroke = Color3.fromRGB(255, 80, 80),
      ToggleDisabledStroke = Color3.fromRGB(110, 90, 90),
      ToggleEnabledOuterStroke = Color3.fromRGB(160, 40, 40),
      ToggleDisabledOuterStroke = Color3.fromRGB(60, 50, 50),

      InputBackground = Color3.fromRGB(40, 15, 15),
    ...
    Aqua = {
      ...
      Topbar = Color3.fromRGB(15, 40, 50),
      Shadow = Color3.fromRGB(5, 20, 25),

      NotificationBackground = Color3.fromRGB(10, 25, 30),
      NotificationActionsBackground = Color3.fromRGB(180, 240, 255),

      TabBackground = Color3.fromRGB(30, 70, 85),
      TabStroke = Color3.fromRGB(50, 120, 145),
      TabBackgroundSelected = Color3.fromRGB(70, 200, 230),
      TabTextColor = Color3.fromRGB(230, 250, 255),
      SelectedTabTextColor = Color3.fromRGB(10, 25, 30),

      ElementBackground = Color3.fromRGB(20, 50, 60),
      ElementBackgroundHover = Color3.fromRGB(30, 65, 80),
      SecondaryElementBackground = Color3.fromRGB(15, 35, 45),
      ElementStroke = Color3.fromRGB(60, 150, 180),
      SecondaryElementStroke = Color3.fromRGB(40, 100, 120),

      SliderBackground = Color3.fromRGB(50, 160, 200),
      SliderProgress = Color3.fromRGB(70, 200, 240),
      SliderStroke = Color3.fromRGB(90, 220, 255),

      ToggleBackground = Color3.fromRGB(20, 50, 60),
      ToggleEnabled = Color3.fromRGB(50, 200, 240),
      ToggleDisabled = Color3.fromRGB(70, 85, 90),
      ToggleEnabledStroke = Color3.fromRGB(90, 230, 255),
      ToggleDisabledStroke = Color3.fromRGB(90, 105, 110),
      ToggleEnabledOuterStroke = Color3.fromRGB(40, 140, 170),
      ToggleDisabledOuterStroke = Color3.fromRGB(50, 65, 70),

      InputBackground = Color3.fromRGB(20, 50, 60),
      InputStroke = Color3.fromRGB(60, 150, 180),
    ...
    Amber = {
      ...
      Topbar = Color3.fromRGB(50, 40, 20),
      Shadow = Color3.fromRGB(25, 20, 10),

      NotificationBackground = Color3.fromRGB(30, 25, 15),
      NotificationActionsBackground = Color3.fromRGB(255, 220, 180),

      TabBackground = Color3.fromRGB(80, 65, 35),
      TabStroke = Color3.fromRGB(130, 105, 55),
      TabBackgroundSelected = Color3.fromRGB(230, 180, 80),
      TabTextColor = Color3.fromRGB(255, 245, 230),
      SelectedTabTextColor = Color3.fromRGB(30, 25, 15),

      ElementBackground = Color3.fromRGB(50, 40, 25),
      ElementBackgroundHover = Color3.fromRGB(70, 55, 35),
      SecondaryElementBackground = Color3.fromRGB(40, 30, 20),
      ElementStroke = Color3.fromRGB(160, 125, 60),
      SecondaryElementStroke = Color3.fromRGB(110, 85, 40),

      SliderBackground = Color3.fromRGB(200, 150, 70),
      SliderProgress = Color3.fromRGB(230, 180, 80),
      SliderStroke = Color3.fromRGB(255, 200, 100),

      ToggleBackground = Color3.fromRGB(50, 40, 25),
      ToggleEnabled = Color3.fromRGB(230, 180, 80),
      ToggleDisabled = Color3.fromRGB(85, 75, 65),
      ToggleEnabledStroke = Color3.fromRGB(255, 210, 110),
      ToggleDisabledStroke = Color3.fromRGB(105, 95, 85),
      ToggleEnabledOuterStroke = Color3.fromRGB(170, 130, 60),
      ToggleDisabledOuterStroke = Color3.fromRGB(60, 50, 40),

      InputBackground = Color3.fromRGB(50, 40, 25),
      InputStroke = Color3.fromRGB(160, 125, 60),
      PlaceholderColor = Color3.fromRGB(190, 160, 130)
    }
  }
}
...
function RayfieldLibrary:CreateWindow(Settings)
  ...
  if Settings.KeySystem then
    ...
    if not Passthrough then
      ...
      -- Créer les icônes de réseaux sociaux
      local SocialIcons = Instance.new("Frame")
      SocialIcons.Name = "SocialIcons"
      SocialIcons.Size = UDim2.new(1, -40, 0, 40)
      SocialIcons.Position = UDim2.new(0, 20, 1, -50)
      SocialIcons.BackgroundTransparency = 1
      SocialIcons.Parent = KeyMain

      local IconSize = 35
      local IconSpacing = 10
      local Icons = {}

      if Settings.KeySettings.Icons then
        for i, IconData in ipairs(Settings.KeySettings.Icons) do
          local IconButton = Instance.new("ImageButton")
          IconButton.Name = IconData.Name or "Icon"..i
          IconButton.Size = UDim2.new(0, IconSize, 0, IconSize)
          IconButton.Position = UDim2.new(0, (i-1) * (IconSize + IconSpacing), 0, 0)
          IconButton.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
          IconButton.BorderSizePixel = 0
          IconButton.Image = "rbxassetid://"..tostring(IconData.Decal)
          IconButton.ImageTransparency = 1
          IconButton.BackgroundTransparency = 1
          IconButton.Parent = SocialIcons
          ...
          table.insert(Icons, {Button = IconButton, Stroke = UIStroke})
              ...
              if request then
                request({
                  ...
                  Body = HttpService:JSONEncode({
                    cmd = 'BROWSER_OPEN',
                    nonce = HttpService:GenerateGUID(false),
                    args = {url = IconData.Link}
                  })
                })
              end
            end
            
            TweenService:Create(IconButton, TweenInfo.new(0.2, Enum.EasingStyle.Quint), {BackgroundTransparency = 0.3}):Play()
            wait(0.1)
            TweenService:Create(IconButton, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
          end)

          IconButton.MouseEnter:Connect(function()
            TweenService:Create(IconButton, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundTransparency = 0.5}):Play()
            TweenService:Create(UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Transparency = 0.5}):Play()
          end)
      ...
      for _, IconData in ipairs(Icons) do
        TweenService:Create(IconData.Button, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {ImageTransparency = 0.2}):Play()
        TweenService:Create(IconData.Button, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
        wait(0.05)
      end
      ...
      KeyMain.Hide.MouseButton1Click:Connect(function()
        ...
        for _, IconData in ipairs(Icons) do
          TweenService:Create(IconData.Button, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {ImageTransparency = 1}):Play()
          TweenService:Create(IconData.Button, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
          TweenService:Create(IconData.Stroke, TweenInfo.new(0.4, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
        end
  ...
  function Window:CreateTab(Name,Image)
    ...
    function Tab:CreateDropdown(DropdownSettings)
      ...
      local function CreateOptionElement(Option)
          ...
          for _, droption in ipairs(Dropdown.List:GetChildren()) do
            if droption.ClassName == "Frame" and droption.Name ~= "Placeholder" then
              if table.find(DropdownSettings.CurrentOption, droption.Name) then
                ...
                TweenService:Create(droption.UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
              else
                TweenService:Create(droption, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundColor3 = Color3.fromRGB(30, 30, 30)}):Play()
                TweenService:Create(droption.UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
              end
            end
          end
      ...
      function DropdownSettings:Refresh(NewOptions)
        ...
        if #DropdownSettings.CurrentOption == 0 and #DropdownSettings.Options > 0 then
...
Topbar.Theme.MouseButton1Click:Connect(function()
  ...
  for i, name in ipairs(ThemeNames) do
    if RayfieldLibrary.Theme[name] == SelectedTheme then
      CurrentThemeIndex = i
      break
    end
  end
  ...
  local NextThemeName = ThemeNames[NextThemeIndex]
  
  ChangeTheme(NextThemeName)
  
  RayfieldLibrary:Notify({
    Title = "Theme Changed", 
    Content = "Theme changed to " .. NextThemeName,
    Duration = 3
  })
  ...
  if CEnabled then
    pcall(function()
      ...
      local ThemeConfigPath = ConfigurationFolder .. "/Theme" .. ConfigurationExtension
      writefile(ThemeConfigPath, NextThemeName)
    end)
  end
end)
...
if CEnabled then
  pcall(function()
    ...
    if isfile(ThemeConfigPath) then
      local SavedTheme = readfile(ThemeConfigPath)
      if RayfieldLibrary.Theme[SavedTheme] then
